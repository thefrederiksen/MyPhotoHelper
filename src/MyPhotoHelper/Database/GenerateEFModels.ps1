...
$command = 'Scaffold-DbContext "Data Source=Database\dev_myphotohelper.db" Microsoft.EntityFrameworkCore.Sqlite -OutputDir Models -ContextDir Data -Context MyPhotoHelperDbContext -Force -NoPluralize -UseDatabaseNames'
...
Write-Host "dotnet ef dbcontext scaffold `"Data Source=Database\dev_myphotohelper.db`" Microsoft.EntityFrameworkCore.Sqlite --output-dir Models --context-dir Data --context MyPhotoHelperDbContext --force --no-pluralize --use-database-names" -ForegroundColor Gray